...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body { font-family: 'DejaVu Sans', sans-serif; font-size: 13px; color: #333333; line-height: 1.5; padding: 40px; }
        .header { width: 100%; margin-bottom: 30px; border-bottom: 3px solid #4F46E5; padding-bottom: 20px; }
        ...
        .company-email { color: #6B7280; font-size: 12px; }
        .invoice-title { font-size: 28px; color: #111827; text-transform: uppercase; font-weight: bold; margin-bottom: 5px; }
        .invoice-number { font-size: 14px; font-weight: bold; color: #374151; }
        .badge { display: inline-block; padding: 4px 12px; border-radius: 4px; font-size: 11px; font-weight: bold; text-transform: uppercase; margin-top: 8px; }
        ...
        .invoice-dates { float: right; width: 50%; text-align: right; }
        .section-title { color: #6B7280; font-size: 11px; text-transform: uppercase; margin-bottom: 8px; font-weight: bold; letter-spacing: 0.5px; }
        .customer-name { font-size: 16px; font-weight: bold; color: #111827; margin-bottom: 4px; }
        .customer-detail { margin: 2px 0; color: #4B5563; font-size: 12px; }
        .date-row { margin: 6px 0; font-size: 12px; }
        .date-label { font-weight: bold; color: #374151; }
        .items-table { width: 100%; border-collapse: collapse; margin-bottom: 30px; }
        .items-table thead { background-color: #F3F4F6; }
        .items-table th { color: #374151; text-align: left; padding: 12px 10px; border-bottom: 2px solid #E5E7EB; font-size: 11px; text-transform: uppercase; font-weight: bold; letter-spacing: 0.5px; }
        .items-table td { padding: 12px 10px; border-bottom: 1px solid #E5E7EB; font-size: 12px; }
        ...
        .total-row td { font-size: 18px; font-weight: bold; border-top: 2px solid #4F46E5; color: #4F46E5; padding-top: 12px; margin-top: 8px; }
        .footer { margin-top: 60px; text-align: center; color: #6B7280; font-size: 11px; border-top: 1px solid #E5E7EB; padding-top: 20px; clear: both; }
        .footer-title { font-weight: bold; margin-bottom: 5px; color: #374151; }
    </style>
</head>
<body>
